                    ...
                    <List.Item key={id + "_" + item.uri + "_" + item.owner}>
                      ...
                      <div>
                        ...
                        <Button
                          onClick={() => {
                            console.log("writeContracts", writeContracts);
                            tx(writeContracts.YourCollectible.badTransfer(address, transferToAddresses[id], id));
                          }}
                        >
                          Transfer
                        </Button>
                        ...
                        <Button
                          onClick={() => {
                            tx(writeContracts.YourCollectible.changeContractURI("QmVHi3c4qkZcH3cJynzDXRm5n7dzc9R9TUtUcfnWQvhdcw", id));
                          }}
                        >
                          Change URI
                        </Button>
                        ...
                        <Button
                          onClick={() => {
                            tx(writeContracts.YourCollectible.evolve(id));
                          }}
                        >
                          Evolve
                        </Button>
